...
{
    public class Update : AbstractFactory.IFactory<Model.EnterpriseUser>
    {
        public bool Parameter(EnterpriseUser _obj)
        {
            return DataAccess.SqlAccess().ExecuteNonQuery(SQL<EnterpriseUser>.Update(_obj, string.Format(" AND ID={0}", _obj.ID))) > 0;
        }
