...
{
    public class Update : AbstractFactory.IFactory<Model.OrderConferenceRoom>
    {
        public bool Parameter(OrderConferenceRoom _obj)
        {
            return DataAccess.SqlAccess().ExecuteNonQuery(SQL<OrderConferenceRoom>.Update(_obj, string.Format(" AND ID={0}", _obj.ID))) > 0;
        }
