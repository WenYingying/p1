<%@ WebHandler Language="C#" Class="DeleteInformationHandler" %>

using System;
using System.Web;

public class DeleteInformationHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            if (BLL.BLL<Model.Information>.Creator("delete").Parameter(_obj))
            {
