<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Finance_Default" %>
    ...
    <div class="content">
        ...
        <div class="content_list">
            <asp:Repeater ID="rpList" runat="server">
                <ItemTemplate>
                    <a href="Detail.aspx?ID=<%#Eval("ID") %>" class="financing">
                        ...
                        <div class="right">
                            <ul>
                                ...
                                <li class="money">
                                    <span>融资规模<%#Convert.ToUInt64(Eval("Money")).ToString("###,###") %>万</span>
