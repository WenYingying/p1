<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SubMaster/SubEnterpriseManageMasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="EnterpriseManage_News_Add" %>
    ...
    <div class="bottom">
        <ul>
            ...
            <li style="overflow: visible; position: relative;">
                <span>上传图片</span>
                <label style="position: relative; width:auto; display:none;">
                    <a class="process"></a>
                    <img src="" />
                </label>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var postFunc = function (e) {
                ...
                var data = { "Title": escape($.trim($("#Title").val())), "Type": "News", "Tags": escape($.trim($("#Tags").val())), "Content": escape($.trim($("#Content").val())), "CoverPic": escape($.trim($("#CoverPic").val())), "UserId": "<%=((Master_SubMaster_SubEnterpriseManageMasterPage)(this.Master)).user.ID%>", "EnterpriseId": "<%=((Master_SubMaster_SubEnterpriseManageMasterPage)(this.Master)).user.EnterpriseId%>" };
                $.post("../../Handler/PostInformationHandler.ashx", data, function (res) {
