<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SubMaster/SubEnterpriseManageMasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="EnterpriseManage_Hr_Add" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="phPageContent" runat="Server">
    <div class="bottom">
        <ul>
            <li title="请输入岗位">
                <span>职位名称</span>
                <input type="text" name="" id="PositionName" value="" placeholder="请输入职位名称" />
                <b class="required">*</b>
            </li>
            <li>
                <span>最低学历</span>
            ...
            <li title="请输入部门">
                <span>所属部门</span>
                <input type="text" name="" id="Depart" value="" placeholder="请输入所属部门" />
                <b class="required">*</b>
            </li>
            <li>
                <span>薪　　资</span>
            ...
            <li>
                <span>专业要求</span>
                <input type="text" name="" id="Major" value="" placeholder="请输入专业要求" />
            </li>
            ...
            <li class="bottom_table" title="请输入详细的招聘信息">
                <span>职位描述</span>
                <textarea class="bottom_top" id="Detail"></textarea>
                <b class="required">*</b>
            </li>
            <li class="bottom_table">
                <span></span>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var postFunc = function (e) {
                ...
                var data = { "PositionName": escape($.trim($("#PositionName").val())), "Degree": escape($.trim($("#Degree").val())), "Trade": escape($.trim($("#Trade").val())), "Depart": escape($.trim($("#Depart").val())), "Salary": escape($.trim($("#Salary").val())), "Major": escape($.trim($("#Major").val())), "Welfare": escape($.trim($("#Welfare").val())), "Detail": escape($.trim($("#Detail").val())), "EnterpriseId": "<%=((Master_SubMaster_SubEnterpriseManageMasterPage)(this.Master)).user.EnterpriseId%>" };
                $.post("../../Handler/PostHrHandler.ashx", data, function (res) {
