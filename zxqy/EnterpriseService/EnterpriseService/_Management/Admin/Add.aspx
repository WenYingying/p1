<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="_Management_Admin_Add" %>
    ...
    <div class="iframe_right">
        ...
        <div class="enter_info">
            <ul>
                <li>
                    <span>登录账号</span>
                    <input type="text" name="" id="LoginName" value="" placeholder="请输入登录账号" />
                </li>
                <li>
                    <span>密　　码</span>
                ...
                <li>
                    <span>确认密码</span>
                    <input type="password" name="" id="cmPassword" value="" placeholder="请确认密码" />
                </li>
                <li>
                    <span>电子邮件</span>
                    <input type="text" name="" id="Email" value="" placeholder="请输入公司Email" />
                </li>
                <li>
                    <span>姓　　名</span>
                ...
                <li class="gender">
                    <span>性　　别</span>
                    <input type="radio" name="Gender" id="" value="1" checked="checked" />男
						<input type="radio" name="Gender" id="" value="0" />女
                </li>
                <li>
                    <span>公司职位</span>
                    <input type="text" name="" id="Position" value="" placeholder="请输入公司职位" />
                </li>
                <li>
                    <span>手机号码</span>
                    <input type="text" name="" id="Mobile" value="" placeholder="请输入手机号码" />
                </li>
                <li>
                    <span></span>
                    <div>
    ...
    <script type="text/javascript">
        $(function () {
            var postFunc = function (e) {
                ...
                $.post("../../Handler/PostAdminHandler.ashx", { LoginName: escape(LoginName), Password: Password, Email:Email, Name: escape(Name), Gender: Gender, Position: escape(Position),Mobile:Mobile }, function (res) {
